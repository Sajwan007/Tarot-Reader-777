...
export function ConfirmationPage() {
  return <div className="min-h-screen pt-20 flex items-center justify-center bg-cosmic-dark relative overflow-hidden">
      {/* Celebration Confetti Effect (CSS/SVG) */}
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(30)].map((_, i) => <motion.div key={i} className="absolute bg-gold rounded-full opacity-50" initial={{
        top: '50%',
        left: '50%',
        width: 4,
        height: 4,
