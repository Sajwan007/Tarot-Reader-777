...
export function Footer() {
  return <footer className="bg-cosmic-dark border-t border-white/10 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-white/60 hover:text-gold transition-colors text-sm">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/#services" className="text-white/60 hover:text-gold transition-colors text-sm">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/#about" className="text-white/60 hover:text-gold transition-colors text-sm">
                  About Reader
                </Link>
              </li>
              <li>
                <Link to="/booking" className="text-white/60 hover:text-gold transition-colors text-sm">
                  Book Reading
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <a href="mailto:hello@mystictarot.com" className="flex items-center gap-2 text-white/60 hover:text-gold transition-colors text-sm">
