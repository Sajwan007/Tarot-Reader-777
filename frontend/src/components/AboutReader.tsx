...
export function AboutReader() {
  return <section id="about" className="py-24 bg-cosmic-dark relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          once: true
            ...
            <div className="relative z-10 rounded-2xl overflow-hidden border-2 border-gold/20 shadow-2xl">
              <img src="https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Tarot Reader" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
