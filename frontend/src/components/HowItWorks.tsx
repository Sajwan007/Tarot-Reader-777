...
export function HowItWorks() {
  ...
  return <section className="py-24 bg-cosmic-purple/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          delay: index * 0.2
              ...
              {index < steps.length - 1 && <div className="hidden lg:block absolute top-10 left-1/2 w-full h-[2px] bg-gradient-to-r from-gold/50 to-transparent -z-10" />}
